...
if __name__ == "__main__":
    # Generated files (dataset.json, output.json, output.html) go here instead of
    # the repo root, so they don't pile up or collide with prompt-engineering/'s copies.
